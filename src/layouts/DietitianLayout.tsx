...
const DietitianLayout = () => {
  ...
  const links = [
    { to: "/dietitian/dashboard", icon: <Home className="w-5 h-5" />, label: "Dashboard" },
    { to: "/dietitian/patients", icon: <Users className="w-5 h-5" />, label: "Patients" },
    { to: "/dietitian/appointments", icon: <Calendar className="w-5 h-5" />, label: "Appointments" },
    { to: "/dietitian/plans", icon: <FileText className="w-5 h-5" />, label: "Diet Plans" },
  ];
