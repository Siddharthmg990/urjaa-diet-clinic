...
const DietPlans = () => {
  ...
  const renderPlanDetails = (plan: typeof dietPlans[0]) => {
    return (
          ...
          <div className="flex justify-between items-start">
            ...
            {plan.type === "active" && (
              <div className="text-right">
                <Badge className="bg-nourish-primary">{plan.progress}% Complete</Badge>
                <Progress value={plan.progress} className="h-2 w-24 mt-2" />
              </div>
            )}
            {plan.type === "past" && (
